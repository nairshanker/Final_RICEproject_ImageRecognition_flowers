...
def load_model():
    ...
    model = keras.models.load_model('C:/ShankersDocs/EDUCATION/RICE_Bootcamp_DataAnalytics/FinalProject_Img_Recognition_Flowers/Final_RICEproject_ImageRecognition_flowers/model_2')
    ...
    # model.load_weights('C:/ShankersDocs/EDUCATION/RICE_Bootcamp_DataAnalytics/final_project/new_flower_project/model_2.hdf5')
